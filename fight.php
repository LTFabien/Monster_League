            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="text-center">Winner:
                        <?php if ($fightResult['winner']) { ?> <!-- on affiche ici notre vainqueur suite à l'appel de notre fonction fight située dans functions.php -->
                            <?php echo $fightResult['winner']->getName(); ?>
                        <?php } else { ?>
                            Nobody <!-- On affiche Nobody s'il n'ya pas de vainqueur (càd si les deux monstres se tuent à la même itération) -->
                        <?php } ?>
                    </h3>
